---
{
  ...
  "date": "",
  "length": 221461,
  "crawled_at": "2026-04-23T20:56:39"
}
---
...
5
1.2
.  History and Context for This Document  . . . . . . . . . .
5
1.3
...
21
3.5
.  Commands for Debugging Addresses . . . . . . . . . . . . .
22
3.5.1
.  Overview . . . . . . . . . . . . . . . . . . . . . . .
22
3.5.2
.  VRFY Normal Response . . . . . . . . . . . . . . . . .
24
3.5.3
.  Meaning of VRFY or EXPN Success Response . . . . . . .
25
3.5.4
.  Semantics and Applications of EXPN . . . . . . . . . .
26
3.6
.  Relaying and Mail Routing  . . . . . . . . . . . . . . . .
26
3.6.1
.  Source Routes and Relaying . . . . . . . . . . . . . .
26
3.6.2
.  Mail eXchange Records and Relaying . . . . . . . . . .
26
3.6.3
.  Message Submission Servers as Relays . . . . . . . . .
27
3.7
.  Mail Gatewaying  . . . . . . . . . . . . . . . . . . . . .
28
...
46
4.2.1
.  Reply Code Severities and Theory . . . . . . . . . . .
48
4.2.2
...
64
4.5.3.1.9
.  Treatment When Limits Exceeded . . . . . . . .
64
4.5.3.1.10
. Too Many Recipients Code . . . . . . . . . . .
64
4.5.3.2
.  Timeouts . . . . . . . . . . . . . . . . . . . . .
65
...
76
7.4
.  Mail Rerouting Based on the 251 and 551 Response Codes . .
77
7.5
...
1
   ...
   (see
Section 3.6
).  A network consists of the mutually-TCP-accessible
...
12
   ...
   o  the clarifications and applicability statements in
RFC 1123
[
3
],
   ...
   o  material drawn from the SMTP Extension mechanisms in
RFC 1869
[
13
].
...
RFC 5321
SMTP                      October 2008
o  Editorial and clarification changes to
RFC 2821
[
14
] to bring that
...
RFC
1123
(replacing the mail transport materials of
RFC 1123
).  However,
RFC 821
specifies some features that were not in significant use in
   ...
   clarity and brevity; readers needing them should refer to
RFC 821
.

   It also includes some additional material from
RFC 1123
that required
...
[
18
] is now preferred to direct use of SMTP; more
...
[
4
], discusses message header sections
...
5
   ...
   preserved from
RFC 2821
.  Readers are cautioned that these are
...
18
   ...
   by explicit "source" routing (see
Section 5
and
Appendix C
and
...
Extensions that change fairly basic properties of SMTP operation are
   ...
   minimum limits specified in
Section 4.5.3
, can change the ASCII
...
SMTP transports a mail object.  A mail object contains an envelope
   ...
   (described in
Section 3
).  It consists of an originator address (to
...
[
21
]).  The content is textual in nature, expressed using
...
[
22
]) may relax this restriction for the content
...
In
RFC 821
, the two hosts participating in an SMTP transaction were
...
2.3.3
.  Mail Agents and Message Stores
Additional mail system terminology became common after
RFC 821
was
...
A domain name (or often just a "domain") consists of one or more
   ...
   components ("labels" in DNS terminology,
RFC 1035
[
2
]) are restricted
   for SMTP purposes to consist of a sequence of letters, digits, and
   hyphens drawn from the ASCII character set [
6
].  Domain names are
   ...
   deliver mail instead of representing a host name.  See
RFC 1035
[
2
]
...
2
   ...
   in
Section 5
) are permitted, as are CNAME RRs whose targets can be
...
o  The reserved mailbox name "postmaster" may be used in a RCPT
      command without domain qualification (see
Section 4.1.1.3
) and
...
25
   ...
   and more specific completion codes (see also
RFC 5248
[
26
]).
...
[
21
]) provides the standard mechanisms for structured message
   bodies.
2.3.10
.  Originator, Delivery, Relay, and Gateway Systems
This specification makes a distinction among four types of SMTP
   ...
   even if SMTP is used on both sides of them (see
RFC 2979
[
27
]).
...
SMTP commands and replies have a rigid syntax.  All commands begin
   ...
   definitions of commands and replies appear in
Section 4
.
...
[
22
]. 8BITMIME SHOULD be supported by SMTP
...
[
7
].  Metalanguage terms used in running
...
This section contains descriptions of the procedures used in SMTP:
   ...
   Several complete scenarios are presented in
Appendix D
.
...
An SMTP session is initiated when a client opens a connection to a
   ...
   maintaining the required "postmaster" address (see
Section 4
).
   ...
   for the client to send a QUIT (see
Section 4.1.1.10
) before closing
...
.)  A series of one or more RCPT
   ...
   brackets), which can be used to report errors (see
Section 4.2
for a
...
data.  If accepted, the SMTP server returns a "250 OK" reply.  The
   ...
   failure" and return a mail message as discussed in
Section 6
and, in
   particular, in
Section 6.1
...
final address may not even be reachable by the sender.  Consequently,
   the "forwarding" mechanisms described in
Section 3.2 of RFC 821
, and
   especially the 251 (corrected destination) and 551 reply codes from
   RCPT must be evaluated carefully by implementers and, when they are
   available, by those configuring systems (see also
Section 7.4
).
...
[
25
], will facilitate automated translation into other languages
...
[
3
], if EXPN is supported, it MUST be
...
A server MUST NOT return a 250 code in response to a VRFY or EXPN
   ...
   cases parallel the discussion of RCPT verification in
Section 2.1
.
   Similarly, the discussion in
Section 3.4
applies to the use of reply
...
12
   ...
   When source routes are not used, the process described in
RFC 821
for
...
A relay SMTP server is usually the target of a DNS MX record that
   ...
   the rules in
Section 5
), and sends it the mail.  If it declines to
...
18
   ...
   and final delivery systems; see Sections
3.7
and
5
.
...
SMTP                      October 2008
Section 4.5.5
for additional discussion).  A MAIL command with a null
...
Section 6.3
   ...
   modifications of these header fields or text (see also
Section 7.9
).
3.7
.  Mail Gatewaying
While the relay function discussed above operates within the Internet
   ...
   discussed in
Section 2.3.10
, when such a system is at the boundary
...
Header fields MAY be rewritten when necessary as messages are
   ...
   destination address in spite of the prohibitions in
Section 6.4
.
   ...
   the
RFC 822
header section or provide similar functionality with a
   ...
   might risk disclosure of private information (see
Section 7.2
).
...
From the Internet side, the gateway SHOULD accept all valid address
   formats in SMTP commands and in the
RFC 822
header section, and all
   valid
RFC 822
messages.  Addresses and header fields generated by
   gateways MUST conform to applicable standards (including this one and
RFC 5322
[
4
]).  Gateways are, of course, subject to the same rules
...
The gateway MUST ensure that all header fields of a message that it
   ...
   satisfy the standard header syntax of
RFC 5322
[
4
], MUST reference
...
An SMTP connection is terminated when the client sends a QUIT
   ...
   normal operational circumstances (see
Section 7.8
) except:
...
An SMTP-capable host SHOULD support both the alias and the list
   ...
   However, in this case, the message header section (
RFC 5322
[
4
]) MUST
...
A mailing list may be said to operate by "redistribution" rather than
   ...
   the key difference between handling aliases (
Section 3.9.1
) and
...
RFC 2821
, and some earlier informal practices, encouraged following
...
.
   ...
   required) for all commands not listed as "required" in
Section 4.5.1
...
This command is used to initiate a mail transaction in which the mail
   ...
   when no mail transaction is in progress, see
Section 4.1.4
.
...
This command is used to identify an individual recipient of the mail
   ...
   As provided in
Appendix C
, xyz.com MAY also choose to relay the
...
Section 2.3.7
   ...
   actually the terminator of the previous line (see
Section 4.5.2
).
...
[
4
] be transmitted).  An extra <CRLF> MUST NOT
...
body were passed to the originating SMTP-sender with a final "line"
   ...
   takes full responsibility for the message (see
Section 6.1
).  Errors
...
This command asks the receiver to confirm that the argument
   ...
   containing information as described in
Section 3.5
.  This reply will
...
This command specifies that the receiver MUST send a "221 OK" reply,
   ...
   Syntax:
      ...
      quit = "QUIT" CRLF
4.1.1.11
.  Mail-Parameter and Rcpt-Parameter Error Responses
...
Sometimes a host is not known to the domain name system and
   ...
   format specified as part of the relevant standards (i.e.,
RFC 4291
[
8
] for IPv6).
...
As specified in
Section 2.2.2
, commands starting in "X" may be used
...
Questions have been raised as to when reply code 502 (Command not
   ...
   500) replies.
4.2.5
.  Reply Codes after DATA and the Subsequent <CRLF>.<CRLF>
...
.
   ...
   o  The ID clause MAY contain an "@" as suggested in
RFC 822
, but this
      is not required.
...
receiver need merely do some simple arithmetic to convert the values.
   ...
   balance of the mail header section and then the body (
RFC 5322
[
4
]).
   ...
   SHOULD be present when the message is delivered.  Systems using
RFC
822
...
RFC 5321
SMTP                      October 2008
Historical note: Text in
RFC 822
that appears to contradict the use
   ...
   handling aliases (
Section 3.9.1
) and forwarding (this subsection) is
...
.
   ...
   follows (the definitions for "FWS" and "CFWS" appear in
RFC 5322
[
4
]):
...
Stamp          = From-domain By-domain Opt-info [CFWS] ";"
                  FWS date-time
                  ; where "date-time" is as defined in
RFC 5322
[
4
]
...
Section 3.6
for special treatment of these conditions in SMTP systems
...
[
35
]) will often require larger objects.
...
[
21
]), message lengths on the Internet have grown
   ...
   SHOULD implement the "SIZE" service extension of
RFC 1870
[
10
], and
...
[
1
] incorrectly listed the error where an SMTP server
...
There are several types of notification messages that are required by
   ...
   namely non-delivery notifications as discussed in
Section 3.7
, other
   kinds of Delivery Status Notifications (DSNs,
RFC 3461
[
32
]), and
...
[
2
]).  The names are expected to be fully-qualified domain names
   ...
   NOT make such inferences (Message Submission Servers [
18
] have
...
In the contemporary Internet, SMTP clients and servers may be hosted
   ...
   (IPv4), "AAAA RR"s (IPv6), or any combination of them.  While
RFC
3974
[
39
] discusses some operational experience in mixed
...
When the receiver-SMTP accepts a piece of mail (by sending a "250 OK"
   ...
   are discussed in the next subsection and in
Section 7.8
.
...
if this address is null ("<>"), the receiver-SMTP MUST NOT send a
   ...
   the final <CRLF>.<CRLF> end of data indicator.  See
RFC 1047
[
40
] for
...
[
28
]).  Some could not keep adequate track
   ...
   satisfy the assumptions that underlay
RFC 822
's conception of
...
[
18
], for message submission, rather than
...
SMTP mail is inherently insecure in that it is feasible for even
   ...
   bodies, such as those that use digital signatures (see
RFC 1847
[
43
]
   and, e.g., Pretty Good Privacy (PGP) in
RFC 4880
[
44
] or Secure/
   Multipurpose Internet Mail Extensions (S/MIME) in
RFC 3851
[
45
]).
...
As discussed in
Section 3.5
, individual sites may want to disable
...
As discussed in
Section 3.4
, use of the 251 or 551 reply codes to
...
RFC 2821
or earlier.  This document expands
   ...
   o  The first, "Simple Mail Transfer Protocol (SMTP) Service
      Extensions" [
46
], consists of SMTP service extensions with the
      associated keywords, and, as needed, parameters and verbs.  As
      specified in
Section 2.2.2
, no entry may be made in this registry
...
and in this document).  The
   ...
   o  The third, "Mail Transmission Types" [
46
], established by
RFC 821
and renewed by this specification, is a registry of link and
      ...
      in
Section 4.4
.  Link and protocol identifiers in addition to
...
summary of the syntax of the associated String, and a reference.
   ...
   be added to the IANA registry established by
BCP 90
(
RFC 3864
) [
...
9
.  Acknowledgments
Many people contributed to the development of
RFC 2821
.  That
...
RFC 821
.  A considerable quantity of text from
RFC 821
still appears
...
, March 1997.
   ...
   [
6
]   American National Standards Institute (formerly United States
...
, February 2006.
   ...
   [
9
]   Newman, C., "ESMTP and LMTP Transmission Types Registration",
RFC 3848
, July 2004.

   [
10
]  Klensin, J., Freed, N., and K. Moore, "SMTP Service Extension
         for Message Size Declaration", STD 10,
RFC 1870
, November 1995.
...
13
         ...
         Crocker, "SMTP Service Extensions", STD 10,
RFC 1869
,
         November 1995.
...
,
   ...
   [
15
]  Butler, M., Postel, J., Chase, D., Goldberger, J., and J.
         Reynolds, "Post Office Protocol: Version 2",
RFC 937
,
         February 1985.
...
,
   ...
   [
26
]  Hansen, T. and J. Klensin, "A Registry for SMTP Enhanced Mail
         System Status Codes",
BCP 138
,
RFC 5248
...
, August 1982.
   ...
   [
29
]  Wong, M. and W. Schlitt, "Sender Policy Framework (SPF) for
...
, September 2006.
   ...
   [
31
]  Allman, E., Callas, J., Delany, M., Libbey, M., Fenton, J., and
...
, January 1998.
   ...
   [
36
]  De Winter, J., "SMTP Service Extension for Remote Message Queue
         Starting",
RFC 1985
, August 1996.
...
[
39
]  Nakamura, M. and J. Hagino, "SMTP Operational Experience in
...
, January 2005.
   ...
   [
40
]  Partridge, C., "Duplicate messages and SMTP",
RFC 1047
,
         February 1988.
   ...
   [
41
]  Crispin, M., "Interactive Mail Access Protocol: Version 2",
RFC 1176
, August 1990.
...
Some systems use an
RFC 822
header section (only) in a mail
   submission protocol, or otherwise generate SMTP commands from
RFC 822
header fields when such a message is handed to an MTA from a UA.
   ...
   1.  Each recipient address from a TO, CC, or BCC header field SHOULD
       ...
       addresses listed in a
RFC 822
"group".  Any BCC header fields
...
4
   ...
   2.  The return address in the MAIL command SHOULD, if possible, be
       ...
       but may lessen its incidence; see
Section 7.1
.
...
When an MTA is being used in this way, it bears responsibility for
   ...
   A submission protocol based on Standard
RFC 822
information alone
...
Appendix F.2
); while servers MUST be prepared to receive and handle
...
RFC 821
to prevent server actions that might
   ...
   If source routes are used,
RFC 821
and the text below should be
...
A few features of
RFC 821
have proven to be problematic and SHOULD
   NOT be used in Internet mail.
F.1
.  TURN
This command, described in
RFC 821
, raises important security issues
...
.  Source Routing
RFC 821
utilized the concept of explicit source routing to get mail
...
, of a clear requirement that addresses
   ...
   in the main body of this document and in
RFC 1123
.  They MAY, if
...
.  #-literals
RFC 821
provided for specifying an Internet address as a decimal
...
In addition to specifying a mechanism for delivering messages to
   user's mailboxes,
RFC 821
provided additional, optional, commands to
   ...
   implementation model specified in
RFC 821
