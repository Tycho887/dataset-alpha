---
{
  "title": "\n            \n                draft-ietf-oauth-amr-values-06\n            \n        ",
  "url": "https://tools.ietf.org/html/draft-ietf-oauth-amr-values-06",
  ...
  "date": "",
  "length": 30053,
  "crawled_at": "2026-04-23T20:51:29"
}
---
...
Expires: September 1, 2017                                        Oracle
                                                              A. Nadalin
                                                               Microsoft
                                                       February 28, 2017
...
Jones, et al.           Expires September 1, 2017               [Page 1]
Internet-Draft   Authentication Method Reference Values    February 2017
...
Jones, et al.           Expires September 1, 2017               [Page 2]
Internet-Draft   Authentication Method Reference Values    February 2017
...
RFC6749
   ...
   Connect Core 1.0 [
OpenID.Core
].  The existence of the "amr" claim and
   ...
   Profile 1.0 [
OpenID.MODRNA
] is one example of an application context
...
The following is a list of Authentication Method Reference values
   ...
   face
Jones, et al.           Expires September 1, 2017               [Page 3]
Internet-Draft   Authentication Method Reference Values    February 2017
...
Appendix C of [RFC4211]
for a discussion on PoP.
...
RFC4949
      ...
      that this authentication method applies to include [
RFC4226
] and
      [
RFC6238
...
RFC4949
   ...
   rba
Jones, et al.           Expires September 1, 2017               [Page 4]
Internet-Draft   Authentication Method Reference Values    February 2017
...
Jones, et al.           Expires September 1, 2017               [Page 5]
Internet-Draft   Authentication Method Reference Values    February 2017
...
OpenID.Core
   ...
   and OAuth 2.0 [
RFC6749
] and the OAuth 2.0 Threat Model [
RFC6819
]
   ...
   As described in
Section 3
, taking a dependence upon particular
...
Jones, et al.           Expires September 1, 2017               [Page 6]
Internet-Draft   Authentication Method Reference Values    February 2017
...
Authentication Method Reference Name:
      ...
      8 characters without a compelling reason to do so.  To facilitate
   ...
   Authentication Method Reference Description:
      ...
      "One-time password").
Jones, et al.           Expires September 1, 2017               [Page 7]
Internet-Draft   Authentication Method Reference Values    February 2017
Change Controller:
...
of [[ this specification ]]
   ...
   o  Authentication Method Reference Description: Multiple-channel
      authentication
Jones, et al.           Expires September 1, 2017               [Page 8]
Internet-Draft   Authentication Method Reference Values    February 2017
o  Change Controller: IESG
   o  Specification Document(s):
Section 2
...
Section 2
of [[ this specification ]]
Jones, et al.           Expires September 1, 2017               [Page 9]
Internet-Draft   Authentication Method Reference Values    February 2017
...
>.
Jones, et al.           Expires September 1, 2017              [Page 10]
Internet-Draft   Authentication Method Reference Values    February 2017
[
RFC2119
...
>.
   ...
   [
JECM
]     Williamson, G., "Enhanced Authentication In Online
...
>.
   ...
   [
MCA
]      ldapwiki.com, "Multiple-channel Authentication", August
              2016, <
https://www.ldapwiki.com/wiki/Multiple-
channel%20Authentication
>.

   [
MSDN
]     Microsoft, "Integrated Windows Authentication with
...
>.
Jones, et al.           Expires September 1, 2017              [Page 11]
Internet-Draft   Authentication Method Reference Values    February 2017
[
OpenID.MODRNA
]
...
RFC4226
              ...
              Algorithm",
RFC 4226
, DOI 10.17487/RFC4226, December 2005,
              <
...
>.
   ...
   [
SMS
]      3rd Generation Partnership Project, "Technical realization
...
W3C.REC-geolocation-API-20161108
              ...
              API-20161108, November 2016, <
https://www.w3.org/TR/2016/
REC-geolocation-API-20161108
>.
Jones, et al.           Expires September 1, 2017              [Page 12]
Internet-Draft   Authentication Method Reference Values    February 2017
[
W3C.WD-webauthn-20170216
]
...
[[ to be removed by the RFC editor before publication as an RFC ]]
   ...
   o  Specified characters allowed in "amr" values, reusing the IANA
      Considerations language on this topic from
RFC 7638
.
Jones, et al.           Expires September 1, 2017              [Page 13]
Internet-Draft   Authentication Method Reference Values    February 2017
-04
   ...
   o  Clarified that the actual credentials referenced are not part of
      ...
      biometric data.
   o  Clarified that the OAuth 2.0 Threat Model [
RFC6819
] applies to
...
Jones, et al.           Expires September 1, 2017              [Page 14]
Internet-Draft   Authentication Method Reference Values    February 2017
Anthony Nadalin
   Microsoft
...
Jones, et al.           Expires September 1, 2017              [Page 15]