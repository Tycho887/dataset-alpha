...
RFC 6750
OAuth 2.0 Bearer Token Usage          October 2012
Table of Contents
1
. Introduction ....................................................
2
...
14
6.2.1
. The "invalid_request" Error Value ..................
14
6.2.2
. The "invalid_token" Error Value ....................
15
6.2.3
. The "insufficient_scope" Error Value ...............
15
7
. References .....................................................
15
...
The access token provides an abstraction, replacing different
   ...
   and resource server (described in [
RFC6749
]).  The following two
...
When sending the access token in the HTTP request URI, the client
   ...
   by "Uniform Resource Identifier (URI): Generic Syntax" [
RFC3986
],
...
Section 5
   ...
   recommended, due to its security deficiencies (see
Section 5
) and
...
RFC2617
   ...
   The "scope" attribute is defined in
...
.  In addition, the resource server MAY include the
   ...
   Values for the "scope" attribute (specified in
Appendix A.4 of
   [RFC6749]
...
Typically, a bearer token is returned to the client as part of an
   OAuth 2.0 [
RFC6749
] access token response.  An example of such a
   response is:
...
NIST800-63
].  Since this document builds
   on the OAuth 2.0 Authorization specification [
RFC6749
], we exclude a
...
RFC2246
   ...
   be applied using TLS [
RFC5246
] with a ciphersuite that provides
...
Safeguard bearer tokens:  Client implementations MUST ensure that
   ...
   Always use TLS (https):  Clients MUST always use TLS [
RFC5246
]
...
This specification registers the following access token type in the
   OAuth Access Token Types registry defined in [
RFC6749
].
6.1.1
.  The "Bearer" OAuth Access Token Type
...
[
RFC2617
]    Franks, J., Hallam-Baker, P., Hostetler, J., Lawrence,
...
>.
   ...
   [
OMAP
]       Huff, J., Schlacht, D., Nadalin, A., Simmons, J.,
...
The following people contributed to preliminary versions of this
   ...
   evolved into OAuth 2.0 [
RFC6749
].  Michael B. Jones in turn created
