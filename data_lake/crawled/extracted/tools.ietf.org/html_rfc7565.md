---
{
  ...
  "url": "https://tools.ietf.org/html/rfc7565",
  ...
  "date": "",
  "length": 17949,
  "crawled_at": "2026-04-23T20:57:22"
}
---
...
RFC7033
   ...
   when specifying a user's account as a web link [
RFC5988
].  Although
   both the 'mailto' [
RFC6068
...
4
.  Definition
The syntax of the 'acct' URI scheme is defined under
Section 7
of
   ...
   interaction (regarding this distinction, see
Section 1.2.2 of
   [RFC3986]
...
Because an 'acct' URI enables abstract identification only and not
   ...
   particular, how it is dereferenced or resolved; see [
RFC3986
]).  As a
   concrete example, an "Account Information" application of the
   WebFinger protocol [
RFC7033
] might take an 'acct' URI, resolve the
   ...
   links [
RFC5988
]) about the resource.  For example:
...
As specified in [
RFC3986
], the 'acct' URI scheme allows any character
   from the Unicode repertoire [
Unicode
] encoded as UTF-8 [
RFC3629
] and
   then percent-encoded into valid ASCII [
RFC20
].  Before applying any
...
RFC 5890
, DOI 10.17487/RFC5890, August 2010,
              <
...
RFC 5892
, DOI 10.17487/RFC5892, August 2010,
              <
...
RFC6068
              ...
              URI Scheme",
RFC 6068
, DOI 10.17487/RFC6068, October 2010,
              <
...
Acknowledgements
   ...
   specified in [
RFC7033
]; the authors of that specification (Paul
   ...
   incorporated into Sections
3
and
5
.  IESG comments from Richard
