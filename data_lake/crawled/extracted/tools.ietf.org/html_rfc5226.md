---
{
  ...
  "url": "https://tools.ietf.org/html/rfc5226",
  ...
  "date": "",
  "length": 65215,
  "crawled_at": "2026-04-23T20:57:03"
}
---
...
8
4.1
. Well-Known IANA Policy Definitions .........................
9
4.2
. What to Put in Documents That Create a Registry ...........
12
4.3
...
15
5.1
. What to Put in Documents When Registering Values ..........
15
5.2
...
Many protocols make use of fields that contain constants and other
   well-known values (e.g., the Protocol field in the IP header [
IP
] or
   MIME media types [
MIME-REG
]).  Even after a protocol has been defined
   and deployment has begun, new values may need to be assigned (e.g., a
   new option type in DHCP [
DHCP-OPTIONS
] or a new encryption or
   authentication transform for IPsec [
IPSEC
]).  To ensure that such
...
"protocol constant", or "protocol parameter").  Each assignment of a
   ...
   by the ITU are also delegated [
ASSIGNED
]; IANA manages the subtree
...
RFC3748
   ...
   and [
RFC3575
] for examples that have been done for specific
   namespaces.)
...
.
Section 5.2
discusses disputes and appeals in more detail.
...
RFC 2434
was published and has been put to
...
The following are some defined policies, some of which are in use
   ...
   possible, since their meaning is widely understood.
      ...
      Private Use - For private or local use only, with the type and
            ...
            Examples: Site-specific options in DHCP [
DHCP-IANA
], Fibre
            Channel Port Type Registry [
RFC4044
], Exchange Types in the
            IKEv2 header [
RFC4306
].
...
assigned by IANA; with names, specific text strings can
            ...
            Examples: SASL mechanism names [
RFC4422
], LDAP Protocol
            Mechanisms, and LDAP Syntax [
RFC4520
].
      ...
      Expert Review (or Designated Expert) - approval by a Designated
            ...
            when defining the registry.  For example, see Sections
6
and
            7.2 in [
RFC3748
...
RFC4995
      ...
      RFC Required - RFC publication (either as an IETF submission or as
            an RFC Editor Independent submission [
RFC3932
]) suffices.
...
IETF Review - (Formerly called "IETF Consensus" in
            [
IANA-CONSIDERATIONS
]) New values are assigned only through
            RFCs that have been shepherded through the IESG as AD-
            Sponsored or IETF WG Documents [
RFC3932
] [
RFC3978
].  The
            ...
            Examples: IPSECKEY Algorithm Types [
RFC4025
],
            Accounting-Auth-Method AVP values in DIAMETER [
RFC4005
], TLS
            Handshake Hello Extensions [
RFC4366
].
      ...
      Standards Action - Values are assigned only for Standards Track
            ...
            Examples: BGP message types [
RFC4271
], Mobile Node
            Identifier option types [
RFC4283
], DCCP Packet Types
            [
RFC4340
...
The following guidelines are suggested for any evaluation
            ...
            Examples: IPv4 Multicast address assignments [
RFC3171
], IPv4
            IGMP Type and Code values [
RFC3228
], Mobile IPv6 Mobility
            Header Type and Option values [
RFC3775
].
...
the chosen name not be easily confusable with the name of
         ...
         location:
http://www.iana
.org/assignments/foobar-registry]
      ...
      3) The review process that will apply to all future requests for a
         ...
         Designated Expert MUST also be specified (see
Section 3
).
...
for "Private Use", "Reserved", "Unassigned", etc. should be
   ...
   in
Section 4.1
and refer to it by name.  Indeed, this is the
   ...
   For example, RADIUS [
RFC3575
] specifies the use of a Designated
...
http://www.iana
.org/assignments/bootp-dhcp-parameters]
      [
DHCP-OPTIONS
] [
DHCP-IANA
...
IANA-CONSIDERATIONS
      ...
      on the issue of assigning numbers, consult [
RFC2929
], [
RFC3575
],
...
Since
RFC 2434
was published, experience has shown that the
...
- Reassignments should not normally be made without the
      ...
      - It may be appropriate to write up the proposed action and
        ...
        reclaimed some of its "Private Use" options [
RFC3942
].
7
.  Appeals
Appeals of registration decisions made by IANA can be made using the
   ...
   [
IETF-PROCESS
].  Specifically, appeals should be directed to the
...
Information that creates or updates a registration needs to be
   ...
   [
RFC3552
].  It is the responsibility of the IANA considerations
...
Changes include:
      ...
      - Significantly changed the wording in
Section 3
.  Main purpose is
...
[
ASSIGNED
]            Reynolds, J., Ed., "Assigned Numbers:
RFC 1700
...
[
IANA-MOU
]            Carpenter, B., Baker, F., and M. Roberts,
...
, December 2005.
   ...
   [
PROTOCOL-EXT
]        Carpenter, B. and B. Aboba, "Design
                         Considerations for Protocol Extensions", Work
                         in Progress, December 2007.

   [
RFC2929
]             Eastlake 3rd, D., Brunner-Williams, E., and B.
...
, September
   ...
   [
RFC3171
]             Albanna, Z., Almeroth, K., Meyer, D., and M.
...
, August
   ...
   [
RFC3228
]             Fenner, B., "IANA Considerations for IPv4
...
, July 2003.
   ...
   [
RFC3575
]             Aboba, B., "IANA Considerations for RADIUS
...
[
RFC3748
]             Aboba, B., Blunk, L., Vollbrecht, J., Carlson,
...
, June
   ...
   [
RFC3775
]             Johnson, D., Perkins, C., and J. Arkko,
...
, June
   ...
   [
RFC3932
]             Alvestrand, H., "The IESG and RFC Editor
...
,
   ...
   [
RFC3942
]             Volz, B., "Reclassifying Dynamic Host
...
, March 2005.
   ...
   [
RFC4005
]             Calhoun, P., Zorn, G., Spence, D., and D.
...
, August 2005.
   ...
   [
RFC4025
]             Richardson, M., "A Method for Storing IPsec
...
, May 2005.
   ...
   [
RFC4124
]             Le Faucheur, F., Ed., "Protocol Extensions for
...
, June 2005.
   ...
   [
RFC4169
]             Torvinen, V., Arkko, J., and M. Naslund,
...
, November
   ...
   [
RFC4271
]             Rekhter, Y., Ed., Li, T., Ed., and S. Hares,
...
, December 2005.
   ...
   [
RFC4340
]             Kohler, E., Handley, M., and S. Floyd,
...
, April 2006.
   ...
   [
RFC4366
]             Blake-Wilson, S., Nystrom, M., Hopwood, D.,
...
, April
   ...
   [
RFC4395
]             Hansen, T., Hardie, T., and L. Masinter,
...
, June 2006.
   ...
   [
RFC4589
]             Schulzrinne, H. and H. Tschofenig, "Location
                         Types Registry",
RFC 4589
, July 2006.
...
, November 2006.
   ...
   [
RFC4995
]             Jonsson, L-E., Pelletier, G., and K. Sandlund,
