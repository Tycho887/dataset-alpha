---
{
  ...
  "date": "",
  "length": 120133,
  "crawled_at": "2026-04-23T20:57:04"
}
---
...
Abstract
   ...
   revision of Request For Comments (RFC)
2822
, which itself superseded
...
44
Appendix A.1.1
. A Message from One Person to Another with
                   Simple Addressing  . . . . . . . . . . . . . . . .
44
Appendix A.1.2
...
48
Appendix A.5
.   White Space, Comments, and Other Oddities  . . . .
49
Appendix A.6
.   Obsoleted Forms  . . . . . . . . . . . . . . . . .
50
...
50
Appendix A.6.3
. Obsolete White Space and Comments  . . . . . . . .
51
Appendix B
...
RFC0822
   ...
   that were specified in other RFCs such as [
RFC1123
].
...
This document occasionally uses terms that appear in capital letters.
   ...
   meanings of these terms appears in [
RFC2119
].
1.2.2
.  Syntactic Notation
This specification uses the Augmented Backus-Naur Form (ABNF)
   [
RFC5234
] notation for the formal definitions of the syntax of
...
This document is divided into several sections.
   ...
   This section,
section 1
, is a short introduction to the document.
Section 2
lays out the general description of a message and its
   constituent parts.  This is an overview to help the reader understand
   some of the general principles used in the later portions of this
   document.  Any examples in this section MUST NOT be taken as
   specification of the formal syntax of any part of a message.
Section 3
specifies formal ABNF rules for the structure of each part
...
section 3
represents messages as they MUST be created.  There are
   also notes in
section 3
to indicate if any of the options specified
...
and
3
describe messages that are legal to generate
   for purposes of this specification.
Resnick                     Standards Track                     [Page 5]
RFC 5322
Internet Message Format             October 2008
Section 4
of this document specifies an "obsolete" syntax.  There are
   references in
section 3
to these obsolete syntactic elements.  The
   ...
   conformant messages.
Section 5
details security considerations to take into account when
   implementing this specification.
Appendix A
lists examples of different sorts of messages.  These
   examples are not exhaustive of the types of messages that appear on
   the Internet, but give a broad overview of certain syntactic forms.
Appendix B
lists the differences between this specification and
...
At the most basic level, a message is a series of characters.  A
   ...
   as US-ASCII [
ANSI.X3-4.1986
] characters.  For brevity, this document
...
RFC5321
   ...
   specification (and that of [
RFC5321
] if they actually cause
...
Header fields are lines beginning with a field name, followed by a
   ...
   when used in "folding" and "unfolding", as described in
section
2.2.3
...
Some field bodies in this specification are defined simply as
   "unstructured" (which is specified in
section 3.2.5
as any printable
...
The body of a message is simply lines of US-ASCII characters.  The
   ...
   o  Lines of characters in the body MUST be limited to 998 characters,
      ...
      specifically the MIME documents ([
RFC2045
], [
RFC2046
], [
...
RFC4289
]), that extend (and limit) this specification
...
The syntax as given in this section defines the legal syntax of
   ...
   unspecified are taken from the "Core Rules" of [
RFC5234
],
Appendix
B.1
: CR, LF, CRLF, HTAB, SP, WSP, DQUOTE, DIGIT, ALPHA, and VCHAR.
   ...
   the obsolete syntax in
section 4
.  In all cases, these productions
   are to be ignored for the purposes of generating legal Internet
   messages and MUST NOT be used as part of such a message.  However,
   when interpreting messages, these tokens MUST be honored as part of
   the legal syntax.  In this sense,
section 3
defines a grammar for the
   generation of messages, with "obs-" elements that are to be ignored,
   while
section 4
adds grammar for the interpretation of messages.
3.2
.  Lexical Tokens
The following rules are used to define an underlying lexical
   ...
   section defines the tokens used in structured header field bodies.
      ...
      white space tokens and the comment tokens defined in
section 3.2.2
...
quoted-pair     =   ("\" (VCHAR / WSP)) / obs-qp
   ...
   part of a quoted-pair is semantically "invisible".
      ...
      ccontent, qcontent, and in obs-dtext in
section 4
.
3.2.2
.  Folding White Space and Comments
White space characters, including white space used in folding
   (described in
section 2.2.3
), may appear between many elements in
...
section 2.2.3
, may take place.  Wherever folding appears in a message
...
A message consists of header fields, optionally followed by a message
   ...
   characters excluding the CRLF.  (See
section 2.1.1
for explanation.)
...
The header fields of a message are defined here.  All header fields
   ...
   prepended to the message.  See sections
3.6.6
and
3.6.7
for more
...
3.6.4
.  Identification Fields
Though listed as optional in the table in
section 3.6
, every message
   ...
   anywhere in the message identifier.
      ...
      by and used in other protocols (e.g., [
RFC1034
], [
RFC1035
],
...
Note: There are many instances when messages are "changed", but
      ...
      fields such as trace fields (described in
section 3.6.7
) and
      resent fields (described in
section 3.6.6
...
The informational fields are all optional.  The "Subject:" and
   "Comments:" fields are unstructured fields as defined in
section
2.2.1
, and therefore may contain text or folding white space.  The
...
Earlier versions of this specification allowed for different (usually
   ...
   forms MUST NOT be generated according to the grammar in
section 3
,
   ...
   grammar in
section 3
and adding the definitions presented in this
   ...
   that the rule in
section 3.2.2
regarding lines composed entirely of
...
%d65-73 /          ; Military zones - "A"
   ...
   way in [
RFC0822
] and are therefore unpredictable in their meaning.
   ...
   the error in [
RFC0822
], they SHOULD all be considered equivalent to
...
obs-fields      =   *(obs-return /
   ...
   Except for destination address fields (described in
section 4.5.3
),
...
The obs-return and obs-received are again given here as template
   definitions, just as return and received are in
section 3
.  Their
   full syntax is given in [
RFC5321
].
...
RFC4289
   ...
   security issues.  These issues are discussed in [
RFC2045
], [
RFC2046
],
...
, to facilitate sending messages to
   ...
   described in
section 3.6.3
, where the "Bcc:" line is removed from the
   ...
   blind recipient.  When the second method from
section 3.6.3
is used,
...
6
.  IANA Considerations
This document updates the registrations that appeared in [
RFC4021
]
   that referred to the definitions in [
RFC2822
].  IANA has updated the
   Permanent Message Header Field Repository with the following header
   fields, in accordance with the procedures set out in [
RFC3864
].
...
This section presents a selection of messages.  These are intended to
   ...
   between these examples and the syntax described in sections
3
and
4
...
The following are examples of messages that might be sent between two
   individuals.
Appendix A.1.1
.  A Message from One Person to Another with Simple
Addressing
...
The following is a series of three messages that make up a
   ...
   prepended with "Re: " as described in
section 3.6.5
.
...
The following are examples of obsolete (that is, the "MUST NOT
   generate") syntactic elements described in
section 4
of this
   document.
Appendix A.6.1
...
section 4.2
.  Also, the comments and white space throughout
...
RFC2822
   ...
   (*) below are items which appear in
section 4
of this document and
   therefore can no longer be generated.

   The following are the changes made from [
RFC0822
] and [
RFC1123
] to
   [
RFC2822
] that remain in this document:

   1.   Period allowed in obsolete form of phrase.
   2.   ABNF moved out of document, now in [
RFC5234
].
...
RFC 5322
Internet Message Format             October 2008
The following are changes from [
RFC2822
].
