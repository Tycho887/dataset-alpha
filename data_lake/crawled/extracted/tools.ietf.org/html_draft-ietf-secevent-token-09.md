---
{
  ...
  "url": "https://tools.ietf.org/html/draft-ietf-secevent-token-09",
  ...
  "date": "",
  "length": 58207,
  "crawled_at": "2026-04-23T20:50:36"
}
---
...
Expires: October 19, 2018                                      Microsoft
                                                              W. Denniss
                                                                  Google
                                                               M. Ansari
                                                                   Cisco
...
Hunt, et al.            Expires October 19, 2018                [Page 1]
Internet-Draft
...
12
2.4
.  Security Event Token Construction . . . . . . . . . . . .
13
3
...
15
4.1
.  Distinguishing SETs from ID Tokens  . . . . . . . . . . .
16
4.2
.  Distinguishing SETs from Access Tokens  . . . . . . . . .
16
4.3
...
Authors' Addresses  . . . . . . . . . . . . . . . . . . . . . . .
28
Hunt, et al.            Expires October 19, 2018                [Page 2]
Internet-Draft
draft-ietf-secevent-token
April 2018
1
...
Hunt, et al.            Expires October 19, 2018                [Page 3]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
RFC7519
   ...
   SET Recipient
      ...
      as a "recipient" in [
RFC7519
] or "receiver" in related
      specifications.

   Subject
Hunt, et al.            Expires October 19, 2018                [Page 4]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
), a web resource, an entity such as an
...
A SET is a JWT [
RFC7519
] data structure that represents one or more
   ...
   o  The top-level claims in the JWT Claims Set are called the SET
      ...
      Claims" registry [
IANA.JWT.Claims
] or be Public Claims or Private
...
Hunt, et al.            Expires October 19, 2018                [Page 5]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
Section 3
.  Possible uses of multiple values include, but are not
      limited to:
...
The following example shows the JWT Claims Set for a hypothetical
   SCIM [
RFC7644
] password reset SET.  Such a SET might be used by a
   receiver as a trigger to reset active user-agent sessions related to
   the identified user.
Hunt, et al.            Expires October 19, 2018                [Page 6]
Internet-Draft
draft-ietf-secevent-token
April 2018
{
   ...
   o  The "aud" claim, specifying the intended audiences for the event.
      (The syntax of the "aud" claim is defined in
Section 4.1.3 of
      [RFC7519]
.)
...
Hunt, et al.            Expires October 19, 2018                [Page 7]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
2.1.3
.  Consent Example
Hunt, et al.            Expires October 19, 2018                [Page 8]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
2.1.4
.  RISC Example
Hunt, et al.            Expires October 19, 2018                [Page 9]
Internet-Draft
draft-ietf-secevent-token
April 2018
The following example JWT Claims Set is for an account disabled
   ...
   Incident Sharing and Coordination) working group [
RISC
].  The example
...
, this claim contains a
   ...
   "iat" (Issued At) Claim
Hunt, et al.            Expires October 19, 2018               [Page 10]
Internet-Draft
draft-ietf-secevent-token
April 2018
As defined by
...
"events" (Security Events) Claim
   ...
   "toe" (Time of Event) Claim
      ...
      occurred.  This value is a NumericDate (see
Section 2 of
      [RFC7519]
...
Hunt, et al.            Expires October 19, 2018               [Page 12]
Internet-Draft
draft-ietf-secevent-token
April 2018
2.4
...
Hunt, et al.            Expires October 19, 2018               [Page 13]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
Hunt, et al.            Expires October 19, 2018               [Page 14]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
Because [
RFC7519
] states that "all claims that are not understood by
...
Hunt, et al.            Expires October 19, 2018               [Page 15]
Internet-Draft
draft-ietf-secevent-token
April 2018
4.1
...
OAuth 2.0 [
RFC6749
] defines access tokens as being opaque.
   ...
   o  Modify access token validation systems to check for the presence
      ...
      types of tokens.
Hunt, et al.            Expires October 19, 2018               [Page 16]
Internet-Draft
draft-ietf-secevent-token
April 2018
o  Employ explicit typing, as described in
Section 2.3
, and modify
...
JWTs are now being used in application areas beyond the identity
   ...
   Initiation Protocol (SIP) Via Header Field [
RFC8055
] and Personal
   Assertion Token (PASSporT) [
RFC8225
] specifications both define JWT
   ...
   typing, as described in
Section 2.3
, and modify applicable token
...
5
.  Security Considerations
Hunt, et al.            Expires October 19, 2018               [Page 17]
Internet-Draft
draft-ietf-secevent-token
April 2018
5.1
...
SETs may contain sensitive information.  Therefore, methods for
   ...
   TLS 1.2 [
RFC5246
] or a higher version and MAY support additional
...
RFC6125
   ...
   found in "Recommendations for Secure Use of TLS and DTLS" [
RFC7525
].
...
RFC7516
   ...
   signed using JWS [
RFC7515
] so that the SET can be authenticated and
...
Hunt, et al.            Expires October 19, 2018               [Page 18]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
Also, see
Section 4
above for both additional security considerations
...
If a SET needs to be retained for audit purposes, the signature can
   ...
   know the subject.
Hunt, et al.            Expires October 19, 2018               [Page 19]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
Hunt, et al.            Expires October 19, 2018               [Page 20]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
>.
Hunt, et al.            Expires October 19, 2018               [Page 21]
Internet-Draft
draft-ietf-secevent-token
April 2018
[
...
>.
Hunt, et al.            Expires October 19, 2018               [Page 22]
Internet-Draft
draft-ietf-secevent-token
April 2018
[
...
>.
   ...
   [
RFC8055
]  Holmberg, C. and Y. Jiang, "Session Initiation Protocol
              (SIP) Via Header Field Parameter to Indicate Received
              Realm",
RFC 8055
, DOI 10.17487/RFC8055, January 2017,
              <
...
RFC8225
              ...
              Token",
RFC 8225
, DOI 10.17487/RFC8225, February 2018,
              <
...
>.
   ...
   [
RISC
]     OpenID Foundation, "OpenID Risk and Incident Sharing and
              Coordination (RISC) Working Group",
              <
http://openid.net/wg/risc/
>.
Hunt, et al.            Expires October 19, 2018               [Page 23]
Internet-Draft
draft-ietf-secevent-token
April 2018
Appendix A
...
in 2015.  The editors would like to thank
...
:
   ...
   Draft 04 - PH -
Hunt, et al.            Expires October 19, 2018               [Page 24]
Internet-Draft
draft-ietf-secevent-token
April 2018
...
:
   ...
   Draft 00 - PH - First WG Draft based on
draft-hunt-idevent-token
Hunt, et al.            Expires October 19, 2018               [Page 25]
Internet-Draft
draft-ietf-secevent-token
April 2018
Draft 01 - PH - Changes as follows:
   ...
   o  pjh - Clarified the use of "nonce" in contexts where substitution
      is possible.
Hunt, et al.            Expires October 19, 2018               [Page 26]
Internet-Draft
draft-ietf-secevent-token
April 2018
o  mbj - Addressed WGLC comments by Nat Sakimura.
   ...
   o  Changed to using the
RFC 8174
boilerplate instead of the
RFC 2119
boilerplate.
Hunt, et al.            Expires October 19, 2018               [Page 27]
Internet-Draft
draft-ietf-secevent-token
April 2018
Draft 06 - mbj - Changes were as follows:
   ...
   Draft 07 - PH - Text refinement to
Section 3
...
Hunt, et al.            Expires October 19, 2018               [Page 28]