---
{
  ...
  "date": "",
  "length": 33267,
  "crawled_at": "2026-04-23T20:56:54"
}
---
...
Abstract
   ...
   This memo obsoletes and replaces
RFC 2279
.
...
ISO/IEC 10646 [
ISO.10646
] defines a large character set called the
...
o  US-ASCII octet values do not appear otherwise in a UTF-8 encoded
   ...
   (see [
FSS_UTF
]), bearing the names FSS-UTF (variant FSS/UTF), UTF-2
...
CESU-8
   ...
   problems.  See Security Considerations (
Section 10
) below.
4
.  Syntax of UTF-8 Byte Sequences
...
UTF8-3      = %xE0 %xA0-BF UTF8-tail / %xE1-EC 2( UTF8-tail ) /
   ...
   NOTE -- The authoritative definition of UTF-8 is in [
UNICODE
].  This
...
This memo serves as the basis for registration of the MIME charset
   parameter for UTF-8, according to [
RFC2978
   ...
   of characters, nothing more (see
[RFC2045], section 2.2
).  As long as
...
[
CESU-8
]    Phipps, T., "Unicode Technical Report #26: Compatibility
...
>.
   ...
   [
FSS_UTF
]   X/Open Company Ltd., "X/Open Preliminary Specification --
...
UAX15
               ...
               Unicode Standard, Version 4.0.0, April 2003, <
http://
