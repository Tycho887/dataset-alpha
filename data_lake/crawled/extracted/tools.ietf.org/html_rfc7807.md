---
{
  ...
  "date": "",
  "length": 30579,
  "crawled_at": "2026-04-23T20:51:46"
}
---
...
HTTP [
RFC7230
] status codes are sometimes not sufficient to convey
   enough information about an error to be helpful.  While humans behind
   Web browsers can be informed about the nature of the problem with an
   HTML [
W3C.REC-html5-20141028
] response body, non-human consumers of
   so-called "HTTP APIs" are usually not.

   This specification defines simple JSON [
RFC7159
] and XML
   [
...
response body in a machine-readable format, the client can treat it
   ...
   problem (e.g., "out of credit") with a URI [
RFC3986
]; HTTP APIs can
...
RFC7159
   ...
   media type.
Appendix A
defines how to express them in an equivalent
...
For example, an HTTP response carrying JSON problem details:
   ...
   Status) [
RFC4918
] code could be used to encapsulate multiple status
   messages.
...
[RFC7231], Section 6
   ...
   format still behaves correctly.  See
Section 5
for further caveats
   regarding its use.
...
W3C.REC-html5-20141028
   ...
   links [
RFC5988
] to another resource that can be used by machines to
   resolve the problem.
...
RFC6694
   ...
   (
Section 3.1
), the "about:blank" URI is the default value for that
...
Type name:  application
   ...
   Encoding considerations:  Same as [
RFC7159
]
...
>.
   ...
   [
RFC6694
]  Moonesamy, S., Ed., "The "about" URI Scheme",
RFC 6694
,
...
>.
   ...
   [
RFC7303
]  Thompson, H. and C. Lilley, "XML Media Types",
RFC 7303
,
...
HTTP/1.1 403 Forbidden
   ...
   using the referenced XSLT code [
W3C.REC-xml-stylesheet-20101028
].  If
