---
{
  ...
  "date": "",
  "length": 124700,
  "crawled_at": "2026-04-23T20:56:49"
}
---
...
Internet:
   ...
   - Host name to address mappings were maintained by the Network
     ...
     was FTPed by all hosts [RFC-952,
RFC-953
].  The total network
Mockapetris                                                     [Page 1]
RFC 1034
...
decisions about the top levels of the tree originated in
RFC-920
.
Current policy for the top levels is discussed in [
RFC-1032
].  MILNET
...
rules of this memo and those in
RFC-822
...
A detailed discussion of inverse queries is contained in [
RFC-1035
].
3.8
...
there are some administrative groupings discussed in [
RFC-1032
] which
...
dedicated to individual departments or schools.  [
RFC-1033
] catalogs
...
strategy for resolver operation, but leaves details to [
RFC-1035
].
5.3.1
. Stub resolvers
...
Details and implementation hints can be found in [
RFC-1035
].
6
. A SCENARIO
...
[
RFC-805
]       J. Postel, "Computer Mail Meeting Notes",
RFC-805
,
...
[
RFC-812
]       K. Harrenstien, and V. White, "NICNAME/WHOIS",
RFC-812
,
...
, SRI, October 1985.
                ...
                the
RFC-952
format, and is used to obtain copies of the
                host table.
...
[
RFC-1031
]      W. Lazear, "MILNET Name Domain Transition",
RFC-1031
,
                November 1987.
