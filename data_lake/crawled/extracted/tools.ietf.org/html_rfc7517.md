---
{
  ...
  "date": "",
  "length": 92239,
  "crawled_at": "2026-04-23T20:54:44"
}
---
...
JSON Web Key (JWK)                   May 2015
Appendix B
.  Example Use of "x5c" (X.509 Certificate Chain)
                Parameter  . . . . . . . . . . . . . . . . . . . . .
28
Appendix C
...
JWA
   ...
   JWKs and JWK Sets are used in the JSON Web Signature [
JWS
] and JSON
   Web Encryption [
JWE
...
The terms "JSON Web Signature (JWS)", "Base64url Encoding",
   ...
   defined by the JWS specification [
JWS
].
   ...
   "JWE Protected Header" are defined by the JWE specification [
JWE
].
...
DSS
   ...
   for the key.
     ...
     {"kty":"EC",
      ...
      "kid":"Public key used in JWS spec
Appendix A.3
example"
     }

   Additional example JWK values can be found in
Appendix A
.
4
.  JSON Web Key (JWK) Format
...
RFC7159
   ...
   key.
Section 6
of the JSON Web Algorithms (JWA) [
JWA
] specification
...
ECMAScript
   ...
   by
Section 8.1
or be a value that contains a Collision-Resistant
   Name.
...
The "kty" (key type) parameter identifies the cryptographic algorithm
   ...
   established by [
JWA
] or be a value that contains a Collision-
...
The "use" (public key use) parameter identifies the intended use of
   ...
   IANA "JSON Web Key Use" registry established by
Section 8.2
.
...
W3C.CR-WebCryptoAPI-20141211
   ...
   IANA "JSON Web Key Operations" registry established by
Section 8.3
.
...
RFC5246
]; the identity of the server MUST be
   validated, as per
...
RFC5280
   ...
   string in the array is a base64-encoded (
...
RFC5280
   ...
   member is used.  If other members are present, the contents of those
   members MUST be semantically consistent with the related fields in
   the referenced certificate.  See the last paragraph of
Section 4.6
...
This section establishes the IANA "JSON Web Key Parameters" registry
   ...
   registers the parameter names defined in
Section 4
.  The same JWK
...
One should place no more trust in the data cryptographically secured
   ...
   manner should be treated with skepticism.  See Section 10.3 of [
JWS
]
...
[
RFC6030
] about protecting private and symmetric keys, key usage, and
   information leakage also apply to this specification.
9.3
.  RSA Private Key Representations and Blinding
The RSA Key blinding operation [
Kocher
], which is a defense against
...
Assemble the final representation: The JWE Compact Serialization of
   this result, as defined in Section 7.1 of [
JWE
], is the string
