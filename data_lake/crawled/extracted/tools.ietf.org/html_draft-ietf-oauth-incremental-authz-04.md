---
{
  ...
  "url": "https://tools.ietf.org/html/draft-ietf-oauth-incremental-authz-04",
...
Section 4
.e of
Denniss                 Expires November 4, 2020                [Page 1]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
...
3
4
.  Incremental Auth for Confidential Clients . . . . . . . . . .
3
5
.  Incremental Auth for Public Clients . . . . . . . . . . . . .
4
6
...
4
6.2
.  Handling Scope Reductions . . . . . . . . . . . . . . . .
5
7
.  Alternative Approaches  . . . . . . . . . . . . . . . . . . .
5
7.1
.  Alternative for Public Clients  . . . . . . . . . . . . .
6
7.2
.  Alternative for Confidential Clients  . . . . . . . . . .
6
8
.  Privacy Considerations  . . . . . . . . . . . . . . . . . . .
6
8.1
.  Requesting Authorization In Context . . . . . . . . . . .
6
8.2
.  Preventing Overbroad Authorization Requests . . . . . . .
7
8.3
...
Denniss                 Expires November 4, 2020                [Page 2]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
...
In addition to the terms defined in referenced specifications, this
   ...
   "OAuth"  In this document, OAuth refers to OAuth 2.0 [
RFC6749
].
4
.  Incremental Auth for Confidential Clients
For confidential clients, such as web servers that can keep secrets,
   ...
   parameter in the OAuth 2.0 Authorization Request (
Section 4.1.1 of
   [RFC6749]
...
Denniss                 Expires November 4, 2020                [Page 3]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
5
.  Incremental Auth for Public Clients
...
of
   OAuth 2.0 [
RFC8252
]), thus authorization grants shouldn't contain
...
.) using the following
   ...
   Token Response (
Section 4.1.4
of ) MUST include authorization for the
...
Denniss                 Expires November 4, 2020                [Page 4]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
...
RFC6749
   ...
   can be reduced for a grant.  As specified by
section 6
of OAuth 2.0
   [
RFC6749
], scope can be reduced during a token refresh as well.  So
...
This non-normative section discusses some alternative ways to achieve
   ...
   developers.
Denniss                 Expires November 4, 2020                [Page 5]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
7.1
.  Alternative for Public Clients
...
An alternative incremental auth design for confidential clients is to
   ...
   performed using
RFC 6749
without additions, but requires the client
...
Denniss                 Expires November 4, 2020                [Page 6]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
...
Denniss                 Expires November 4, 2020                [Page 7]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
...
RFC8414
   ...
   in
Section 4
(Incremental Auth for Confidential Clients) is
   supported, and "public" indicates that the behavior documented in
Section 5
(Incremental Auth for Public Clients) is supported.
...
RFC8252
   ...
   documented in
Section 4
is used by an impersonating client, it may
...
Denniss                 Expires November 4, 2020                [Page 9]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
...
[[ to be removed by the RFC Editor before publication as an RFC ]]
   ...
   01
Denniss                 Expires November 4, 2020               [Page 10]
Internet-Draft     OAuth 2.0 Incremental Authorization          May 2020
o  Changed a SHOULD to a MUST in
Section 5
...
Author's Address
   ...
   URI:
https://wdenniss.com/incremental-auth
