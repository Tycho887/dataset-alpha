---
{
  ...
  "url": "https://tools.ietf.org/html/rfc3966",
  ...
  "date": "",
  "length": 40012,
  "crawled_at": "2026-04-23T20:56:56"
}
---
...
Abstract
   ...
   numbers.  This document obsoletes
RFC 2806
.
...
This document defines the URI scheme "tel", which describes resources
   ...
   this point.  (This definition is derived from [
E.164
] but encompasses
   ...
   Address-of-record or identifier: The telephone number is understood
      ...
      network, these numbers follow the rules in E.164 [
E.164
], while
...
RFC3192
   ...
   differs as this document describes URIs whereas
RFC 3191
and
RFC 3192
specify electronic mail addresses.
RFC 3191
and
RFC 3192
use "/" to
...
RFC3261
   ...
   The "tel" URI can be used as a request URI in SIP [
RFC3261
] requests.
...
, [
RFC2119
] and indicate requirement levels for compliant
   implementations.
3
.  URI Syntax
...
[
RFC2234
] and uses elements from the core
   definitions (appendix A of
RFC 2234
).

   The syntax definition follows
RFC 2396
[
RFC2396
], indicating the
...
[
RFC2396
]) are equivalent to their "% HEX HEX" percent
   encoding.
...
Two "tel" URIs are equivalent according to the following rules:
   ...
   o  For mandatory additional parameters (
section 5.4
) and the 'phone-
...
Phone numbers MAY contain visual separators.  Visual separators
   ...
   visual separators in order to follow the spirit of
RFC 2396
[
RFC2396
], which remarks that "A URI often needs to be remembered by
...
[
RFC3187
] use visual separators in a manner similar to this
   specification.

   However, even though ITU-T E.123 [
E.123
] recommends the use of space
...
5.1.3
.  Alphabetic, *, and # Characters as Identifiers
...
Globally unique numbers are identified by the leading "+" character.
   ...
   (NSN) numbers as specified in E.123 [
E.123
] and E.164 [
E.164
].
...
ISDN subaddresses typically contain International Alphabet 5 (IA5
   [
T.50
]) characters but may contain any octet value.
5.3
.  Phone Extensions
...
The "tel" URI describes a service, reaching a telephone number, that
   ...
   [
RFC3761
], some other signaling protocols such as H.323, or a
...
SIP can use the "tel" URI anywhere a URI is allowed, for example as a
   ...
   user part, i.e., before the @ symbol (
section 19.1.6 in [RFC3261]
).
   ...
   from TRIP [
RFC3219
].  However, a proxy server could also delegate
...
Compared to
RFC 2806
, references to carrier selection, dial context,
   fax and modem URIs, post-dial strings, and pause characters have been
   removed.  The URI syntax now conforms to
RFC 2396
[
RFC2396
].
...
[
E.123
]    International Telecommunications Union, "Notation for
...
,
   ...
   [
T1.703
]   ANSI, "Allocation of Letters to the Keys of Numeric
...
,
   ...
   [
RFC2806
]  Vaha-Sipila, A., "URLs for Telephone Calls",
RFC 2806
,
              April 2000.
...
, October 2001.
   ...
   [
RFC3192
]  Allocchio, C., "Minimal FAX address format in Internet
              Mail",
RFC 3192
, October 2001.
   ...
   [
RFC3219
]  Rosenberg, J., Salama, H., and M. Squire, "Telephony
