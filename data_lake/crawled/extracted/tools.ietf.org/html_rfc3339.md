---
{
  ...
  "date": "",
  "length": 34575,
  "crawled_at": "2026-04-23T20:56:52"
}
---
...
RFC 3339
Date and Time on the Internet: Timestamps       July 2002
For more information about time scales, see
Appendix E
of [
NTP
],
      Section 3 of [
ISO8601
], and the appropriate ITU documents [ITU-R-
      TF].
3
. Two Digit Years
...
The offset between local time and UTC is often useful information.
   For example, in electronic mail (
RFC2822
, [
IMAIL-UPDATE
]) the local
...
A number of devices currently connected to the Internet run their
   ...
   o  Use Network Time Protocol [
NTP
] to obtain the time in UTC.
...
Human readability has proved to be a valuable feature of Internet
   ...
   date format in [
IMAIL
] has resulted in interoperability problems when
...
If a date/time format includes redundant information, that introduces
   ...
   the day of week from a date (see
Appendix B
), the day of week should
...
ISO8601
   ...
   representations and partial representations.
Appendix A
contains an
...
5.6
. Internet Date/Time Format
The following profile of ISO 8601 [
ISO8601
] dates SHOULD be used in
   new protocols on the Internet.  This is specified using the syntax
   description notation defined in [
ABNF
].
   ...
   date-time       = full-date "T" full-time
      ...
      NOTE: Per [
ABNF
] and ISO8601, the "T" and "Z" characters in this
...
contains sample C code to determine if a year is a leap
   ...
   30T23:59:60Z) or December (XXXX-12-31T23:59:60Z); see
Appendix D
for
...
[
ZELLER
]       Zeller, C., "Kalender-Formeln", Acta Mathematica, Vol.
                  9, Nov 1886.
