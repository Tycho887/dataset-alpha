---
{
  ...
  "url": "https://tools.ietf.org/html/rfc6711",
...
SAML
   ...
   Another definition of an "assurance level" is given in
RFC 4949
[
RFC4949
], which also identifies the roots of such profiles in the
...
The following information must be provided with each registration:
   ...
   Context Class:  A valid XML schema definition for the SAML 2.0 LoA
      Context Class fulfilling the requirements of [
SAML
].  The registry
...
RFC 6711
LoA Registry                   August 2012
The name is defined by the following ABNF (as defined in
RFC 5234
[
RFC5234
]):
...
[
RFC5226
], employing a pool of experts.  IANA will be kindly
