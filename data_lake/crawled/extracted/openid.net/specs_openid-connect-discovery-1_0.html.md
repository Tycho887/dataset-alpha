---
{
  ...
  "date": "",
  "length": 60428,
  "crawled_at": "2026-04-23T20:49:41"
}
---
...
Once the OpenID Provider has been identified,
	...
	is retrieved from a well-known location as a JSON
[RFC8259]
(
...
(
Sakimura, N., Bradley, J., Jones, M., and E. Jay, “OpenID Connect Discovery 1.0 incorporating errata set 1,” November 2014.
)
[OpenID.Discovery.Errata1]
OpenID Connect Discovery 1.0 (final)
(
Sakimura, N., Bradley, J., Jones, M., and E. Jay, “OpenID Connect Discovery 1.0 (final),” February 2014.
)
...
To start discovery of OpenID endpoints, the End-User supplies an
	...
	Any Web input form MUST employ Cross-Site Request Forgery (CSRF) prevention
[OWASP.CSRF]
(
...
parameter to obtain the location of the
      ...
      Use of the
rel
parameter in the request with a value of
http://openid.net/specs/connect/1.0/issuer
...
[RFC7565]
(
Saint-Andre, P., “The 'acct' URI Scheme,” May 2015.
)
,
...
REQUIRED.
	    URL using the
https
scheme with no query or fragment components that the OP asserts as its
	    Issuer Identifier.
...
content type.
	The
openid-configuration
endpoint SHOULD support the use of
Cross-Origin Resource Sharing (CORS)
(
Opera Software ASA, “Cross-Origin Resource Sharing,” July 2010.
)
