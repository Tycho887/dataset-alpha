---
{
  "title": "Final: OpenID Provider\n    Authentication Policy Extension 1.0",
  "url": "https://openid.net/specs/openid-provider-authentication-policy-extension-1_0.html",
  "domain": "openid.net",
  "depth": 1,
  ...
  "date": "",
  "length": 29483,
  "crawled_at": "2026-04-23T20:48:05"
}
---

Final: OpenID Provider
    Authentication Policy Extension 1.0
TOC
Final
D. Recordon
...
4.1.
Custom Assurance Level Name Spaces
5.
...
[RFC2119]
(
Bradner, B., “Key words for use in RFCs to Indicate Requirement           Levels,” 1997.
)
.
TOC
1.2. 
...
[Yadis]
(
Miller, J., Ed., “Yadis Specification 1.0,” 2005.
)
...
When advertising supported custom Assurance Level name
...
4.1. 
Custom Assurance Level Name Spaces
Custom Assurance Levels are optional.  The namespaces may
          be defined by various parties, such as country or industry
          specific standards bodies, or other groups or individuals.
The namespace URI should be chosen with care to be unambiguous
          when used as a <xrd:Type> element to advertise the namespaces
          supported by the OP.
The custom Assurance Level namespace should define the meaning
...
5.1. 
Request Parameters
The following parameters MUST be included during an
OpenID Authentication request
(
specs@openid.net, “OpenID Authentication 2.0,” 2007.
)
[OpenIDAuthentication2.0]
          by the Relying Party that uses this extension unless marked as optional.
openid.ns.pape
Value:
...
(Optional) A list of the name space aliases for the
                  custom Assurance Level name spaces
                  that the RP requests be present in the response,
                  in the order of its preference.
Value: Space separated list of the name space aliases,
                  in the order of the RP's preference.
Example:
...
(Optional) The Assurance Level as defined by the above
                  ...
                  if possible.
Value: Strings defined according to this Assurance
                  Level.
Example:
...
[NIST_SP800‑63]
          ...
          authenticating the End User corresponds to.
...
Appendix A.1.2. 
NIST Authentication Mechanism Levels
This section is designed to highlight the Authentication
...
This table is republished from page 39 of
[NIST_SP800‑63]
(
Burr, W., Dodson, D., and W. Polk, Ed., “Electronic Authentication Guideline,” April 2006.
)
...
It should be noted that NIST Authentication Mechanism Levels 1
