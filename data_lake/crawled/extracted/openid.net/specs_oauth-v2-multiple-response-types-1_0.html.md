---
{
  ...
  "date": "",
  "length": 20948,
  "crawled_at": "2026-04-23T20:49:11"
}
---
...
IANA Considerations
6.1.
OAuth Authorization Endpoint Response Types Registration
6.1.1.
Registry Contents
6.2.
...
Appendix A.
Example using Multiple-Valued Response Type
Appendix B.
Acknowledgements
Appendix C.
Notices
...
The OAuth 2.0 specification allows
	      for registration of space-separated
response_type
parameter values. 
...
2. 
Response Types and Response Modes
The Response Type request parameter
response_type
...
Returning the
id_token
in a fragment reduces the likelihood that the
id_token
leaks
...
4. 
None Response Type
This section registers the Response Type
none
, in accordance
...
One scenario is where a user wishes to purchase an
...
5. 
Definitions of Multiple-Valued Response Type Combinations
This section defines combinations of the values
code
,
token
, and
...
response_type
parameter, a successful response MUST include
	      both an Authorization Code and an
id_token
.
	      The default Response Mode for this Response Type is the fragment encoding
	      and the query encoding MUST NOT be used.
...
The following is non-normative example of an Authorization Request using
	the Multiple-Valued Response Type
code token
