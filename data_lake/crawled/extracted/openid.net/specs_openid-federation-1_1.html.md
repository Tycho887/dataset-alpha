---
{
  "title": "OpenID Federation 1.1 - draft 04",
  ...
  "date": "",
  "length": 222671,
  "crawled_at": "2026-04-23T20:50:17"
}
---

OpenID Federation 1.1 - draft 04
...
, and
   the terms "Authorization Server (AS)",
...
This specification deals with trust operations;
 ...
 using the trust operations,
        other than enabling metadata derivation and exchange for use by those protocols.
¶
...
.
          Federations SHOULD specify mandatory-to-implement signing algorithms.
...
contains examples building and using Trust Chains for trust establishment
 ...
 and creating Resolved Metadata.
¶
Appendix B.
Notices
...
Moved statement about signing Entity Statements with "RS256"
     from this specification to OpenID Federation for OpenID Connect 1.1
...
¶
Removed protocol-specific functionality.
¶
Merged in changes made to OpenID Federation 1.0 as of January 7, 2026.
¶
Appled corrections identified by Andreas Solberg.
¶
Acknowledgements
OpenID Federation 1.1 Acknowledgements
The authors wish to acknowledge the contributions of the following
   organization to this specification:
