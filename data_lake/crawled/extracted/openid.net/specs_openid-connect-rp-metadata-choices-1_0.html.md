---
{
  ...
  "url": "https://openid.net/specs/openid-connect-rp-metadata-choices-1_0.html",
  "domain": "openid.net",
  "depth": 2,
  ...
  "date": "",
  "length": 27947,
  "crawled_at": "2026-04-23T20:50:14"
}
---
...
Enabling the RP to express all the choices that it supports
 ...
 Section 12.1 of OpenID Federation 1.0
[
OpenID.Federation
]
,
...
Authorization Server Metadata parameters in
[
RFC8414
]
.
...
RS256
if it supports either of the other choices
ES256
or
PS256
.
 It SHOULD use one of the choices that it does support, or reject the registration with the
invalid_client_metadata
error when none of the client-provided values are supported.
¶
5.
