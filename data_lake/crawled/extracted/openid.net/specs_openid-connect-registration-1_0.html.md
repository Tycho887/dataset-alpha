---
{
  "title": "Final: OpenID Connect\n    Dynamic Client Registration 1.0 incorporating errata set 2",
  ...
  "date": "",
  "length": 66650,
  "crawled_at": "2026-04-23T20:49:53"
}
---
...
In order for an OpenID Connect Relying Party to utilize OpenID Connect services for
	...
	This specification describes how an RP
...
OpenID Connect Registration 1.0 incorporating errata set 1
(
Sakimura, N., Bradley, J., and M. Jones, “OpenID Connect Dynamic Client Registration 1.0 incorporating errata set 1,” November 2014.
)
[OpenID.Registration.Errata1]
OpenID Connect Registration 1.0 (final)
(
Sakimura, N., Bradley, J., and M. Jones, “OpenID Connect Dynamic Client Registration 1.0 (final),” February 2014.
)
...
array containing a list of the OAuth 2.0
response_type
values that
...
redirect_uris
using custom
	    URI schemes or loopback URLs using the
http
scheme;
	    loopback URLs use
localhost
...
scheme, other than the
	    loopback case for Native Clients.
...
(
Richer, J., Ed., Jones, M., Bradley, J., and M. Machulak, “OAuth 2.0 Dynamic Client Registration Management Protocol,” July 2015.
)
[RFC7592],
...
Client Metadata Name:
sector_identifier_uri
Client Metadata Description: URL using the
https
scheme to be used in
...
Client Metadata Name:
id_token_signed_response_alg
Client Metadata Description: JWS
alg
...
Client Metadata Name:
id_token_encrypted_response_alg
Client Metadata Description: JWE
alg
...
Client Metadata Name:
initiate_login_uri
Client Metadata Description: URI using the
https
scheme that a third party
...
Client Metadata Name:
request_uris
Client Metadata Description: Array of
request_uri
values that are
		pre-registered by the RP for use at the OP
Change Controller: OpenID Foundation Artifact Binding Working Group - openid-specs-ab@lists.openid.net
...
client_secret_jwt
Change Controller: OpenID Foundation Artifact Binding Working Group - openid-specs-ab@lists.openid.net
Specification Document(s): Section 9 of OpenID Connect Core 1.0
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
[OpenID.Registration.Final]
Sakimura, N., Bradley, J., and M. Jones, “
OpenID Connect Dynamic Client Registration 1.0 (final)
,” February 2014.
[RFC7591]
...
[RFC7592]
Richer, J., Ed., Jones, M., Bradley, J., and M. Machulak, “
OAuth 2.0 Dynamic Client Registration Management Protocol
