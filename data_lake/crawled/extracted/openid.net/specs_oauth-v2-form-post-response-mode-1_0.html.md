---
{
  ...
  "date": "",
  "length": 10547,
  "crawled_at": "2026-04-23T20:49:09"
}
---
...
Appendix A.
"form_post" Response Mode Example
Appendix B.
Acknowledgements
Appendix C.
Notices
...
RFC 7230
(
Fielding, R. and J. Reschke, “Hypertext Transfer Protocol (HTTP/1.1): Message Syntax and Routing,” June 2014.
)
[RFC7230],
...
format.
	    ...
	    The method of the form attribute MUST be
POST
.
	    Because the Authorization Response is intended to be used only once,
	    the Authorization Server MUST instruct the User Agent (and any intermediaries)
...
Below is a non-normative request/response/request example as
	...
	demonstrating an auto-submitted
form_post
encoded response.
