---
{
  ...
  "url": "https://openid.net/specs/openid-federation-1_0-43.html",
  "domain": "openid.net",
  "depth": 2,
  ...
  "date": "",
  "length": 333578,
  "crawled_at": "2026-04-23T20:48:42"
}
---
...
The chain that links the statements to one another is verified with
        the signature of each statement, as described in
Section 4
.
¶
...
Note that this cryptographic trust mechanism intentionally does not rely on
   ...
   keys represented as JSON Web Keys (JWKs)
[
RFC7517
]
.
...
to prevent
          cross-JWT confusion, per Section 3.11 of
[
RFC8725
]
.
   Entity Statements without a
typ
header parameter
   or with a different
typ
...
representing the public part of the subject's Federation Entity
       ...
       such as Trust Mark signatures.
              ...
              Every JWK in the JWK Set MUST have a unique
kid
(Key ID) value.
...
OPTIONAL. An array of JSON objects, each representing
              ...
              and MAY contain other claims. The
trust_mark_type
claim in this object MUST have the same value as the
trust_mark_type
claim in the Trust Mark JWT.
¶
trust_mark_type
Identifier for the type of the Trust Mark.
...
and the selected Trust Anchor, sorted as shown in
Section 4
.
...
¶
{
  ...
  "trust_chain": [
      "eyJhbGciOiJSUzI1NiIsImtpZCI6ImMzWnlUR1ZTY0RNeFowd3dka1pQVVZZMFMyRkVRMnBYVjE4dFVFd3ROVlZIV21WVVEwTmlTM2xVU1EiLCJ0eXAiOiJlbnRpdHktc3RhdGVtZW50K2p3dCJ9..WM0dOdLOhC9UTRi_y6lwwu6PmUWv1wc5f8MhKP2qz6b1haa-eyf4Y60iZ2SDeFeg105wHwPSKN8AfRoNyqubOGZMAFmP-sYBeqZatNsGNWjFEHzI9dJwx1oBab5_TDoULarpKSdvuub4NBOBTKFUSDffBG6jzlaK5JiQzMR30-jqSt9qPPWrJepyLQvyFxmvn94OiNQQwJ0oYB1MecJ7r8gmQMCAH4LixD6amKQoCuN0UeN7iEHTs3z_8ZUDihQ7BHf0dtwDCmG_G7xvaNkLPkG6cP2e2-l5kcYbNaUaK0IsX2yB0BkoQOOHlT-_M2TC2Zzg6Nmmw8WpTeraMrSkIQ",
      ...
      "eyJhbGciOiJSUzI1NiIsImtpZCI6IlpXRlRRbWhmVFdaSVRuRlRZM0ZTV2pKdU5HMWZWV05hZWxkNmNtUjFRa0pEYlhaWlRYQm1hM1JWUVEiLCJ0eXAiOiJlbnRpdHktc3RhdGVtZW50K2p3dCJ9..ZenICRAm4zrd65A3tsSN77VLjheJAK09s8sBXQVo2l3r7RrN8pXFKqulZebxfSALF4am58Ry8GeK2N1ZK7B1GlfskAnnIINfi-IpjqquvPW_MXrSo0bLoXnnmruHJ1D0KbONbwdZaOZg4oJRo2PBU009pojheUwcRcNDujCRiQimsvEYlL4YLwpPHjEmt46WviPESnZCgez_oEdoXkNjN3PsOta9de_abjkASYdGgAlBTIbUjAutmErbubjKptxpvycibBLuJ58nkiQZ_KesLRPnDY9hbPf0ZMbtCB_gx8yLlQ9-8nE5_fuxICz1uKR4536txsQFmrCvireBchaZ1A"
  ]
}
Figure 6
:
Example JWS Header with a
trust_chain
Parameter
5.
Metadata
...
Section 3
,
 Entity metadata is located in the
metadata
...
Top-level JSON object members in the metadata data structures MAY use
 any JSON value other than
null
;
 the use of
null
is prohibited to prevent likely
 implementation errors caused by confusing members having
null
values with omitted members.
¶
5.1.
Entity Type Identifiers
...
metadata MUST
          ...
          (the
iss
parameter within the Entity Configuration).
¶
...
metadata MUST
          ...
          (the
iss
claim in the Entity Configuration).
¶
5.1.5.
OAuth Client
The Entity Type Identifier is
...
, and
signed_jwks_uri
in its OpenID Connect or OAuth 2.0 metadata.
...
6.1.3.1.
Standard Operators
This specification defines the following metadata policy
              operators:
¶
6.1.3.1.1.
value
...
null
, the metadata parameter MUST be
                removed.
¶
...
constraints
claim of a Subordinate Statement,
      as described in
Section 3
.
¶
...
OPTIONAL. Array of string Entity Type Identifiers.
              Entity Type Identifiers are defined in
Section 5.1
.
...
This specification uses the syntax of domain name constraints
     specified in Section 4.2.1.10 of
[
RFC5280
]
.
...
.
     Trust Mark delegation JWTs without a
typ
header parameter
     or with a different
typ
...
Validate the signature of the Trust Mark JWT and verify that
                it has not expired.
¶
If the Trust Mark type identifier appears in the
trust_mark_owners
claim
...
delegation
claim.
                The claims for the Trust Mark type identifier
                in the
trust_mark_owners
value
...
If a Trust Mark is issued on behalf of a Trust Mark Owner, then the Trust Anchor SHOULD
            publish the connection between the Trust Mark type identifier
...
claim. This
            ...
            with a designated Trust Mark type identifier to a specified Trust Mark Issuer.
            Also, the Trust Anchor MAY provide an empty array following the Trust Mark type identifier
...
not_found
error code is RECOMMENDED.
     If the
sub
parameter references the Entity
...
request parameter
 ...
 whose Entity Type Identifier is in an
entity_type
...
8.4.
Trust Mark Status
This enables determining whether a Trust Mark that has been issued to
...
sub
parameter. An example use case is to
...
.
     Historical keys JWTs without a
typ
header parameter
     or with a different
typ
...
JWKs in the
keys
claim MAY also contain the
nbf
parameter.  For use in Historical Keys,
iat
and
exp
...
reason
value when indicating the revocation reason
            for a Federation Entity Key. The
reason
MAY be omitted
...
The following table defines Federation Entity Keys revocation reasons.
            These reasons are inspired by Section 5.3.1 of
[
RFC5280
]
.
...
jwks
claim for the Leaf's Entity Types,
     in its
metadata
or
metadata_policy
...
To delegate the Trust Chain evaluation to a trusted third party,
        ...
        a resolve endpoint, as defined in
Section 8.3
.
¶
10.1.
...
Note that an alternative method for resolving a Trust Chain
   ...
   is to use a resolve endpoint, as described in
Section 8.3
.
...
This section describes how the mechanisms defined in this specification
        ...
        Registration, that use Trust Chains, per
Section 10
.
...
Automatic Registration enables an RP to make Authentication Requests
          ...
          following the process defined in
Section 10
.
¶
...
OP metadata parameter with the value
false
.
...
The response to a successful authentication request
     ...
     successful authentication responses defined in
[
OpenID.Core
]
.
...
The error response to an unsuccessful authentication request
     when using Automatic Registration is the same as the
     error authentication responses defined in
[
OpenID.Core
]
.
...
, but instead of its metadata, the
...
endpoint of an OP deployment. In contrast to
...
¶
An example of an Explicit Registration is provided in
Appendix A.3.2
.
¶
12.2.1.
...
jwks
claim of the Subordinate Statement
...
The
jwks
(JSON Web Key Set) claim
   value is a JWK Set, as defined in
[
RFC7517
]
.
...
(JSON Web Key Set) claim
   ...
   This claim is used in this specification in
Section 3
...
language tags are added to member names,
        delimited by a
#
...
organization_name
and
organization_name#de
might occur together in metadata.
¶
15.
Media Types
These media types
...
media type is used to specify that the associated content is
   an Entity Statement, as defined in
Section 3
.
...
application/resolve-response+jwt
media type is used to specify that the associated content is
   a Resolve Response, as defined in
Section 8.3.2
.
   No parameters are used with this media type.
¶
...
application/trust-chain+json
media type is used to specify that the associated content is
   a JSON array representing a Trust Chain, as defined in
Section 4
.
   No parameters are used with this media type.
¶
...
media type is used to specify that the associated content is
   a Trust Mark delegation, as defined in
Section 7.2.1
.
   No parameters are used with this media type.
¶
...
application/jwk-set+jwt
media type is used to specify that the associated content is
   a signed JWK Set, as defined in
Section 8.7.2
.
   No parameters are used with this media type.
¶
...
Processing some OpenID Federation messages requires comparing
 ...
 an
iss
claim might be compared to
 the Entity Identifier in a
sub
claim.
 Comparing Unicode
[
...
The Trust Mark Status endpoint enables querying the status
     ...
     or use the Trust Marked Entities Listing (
Section 8.5
)
     with only the
trust_mark_type
...
This section registers the following media types
[
RFC2046
]
...
The LIGO WIKI RP fetches the Entity Configuration from the
            OP (op.umu.se)
...
The LIGO RP fetches the Entity Configuration from
...
¶
Entity Configuration for the Leaf Entity
                  https://wiki.ligo.org
¶
Subordinate Statement issued by https://incommon.org about
                  https://wiki.ligo.org
¶
...
¶
Fixed #35: Removed requirement for the
value
and
default
...
¶
Follow Implementation Considerations in
[
OpenID.RP.Choices
]
.
...
Fixed #35: Clarified that using non-interoperable JSON, as per Sections
     ...
     policy behavior.
¶
Fixed #162: Trust Mark claim
id
renamed to
trust_mark_id
.
     Other more specific Trust Mark JWT
typ
...
trust_chain_validation_failed
.
     Fixed #89: Improved Entity Statement
jwks
claim description.
¶
...
and
iat
from Trust Mark Status endpoint.
     Use
GET
at Trust Mark Status endpoint.
¶
-39
¶
...
client authentication.
¶
Fixed #43: Allow multiple
type
request parameters in resolve requests.
¶
...
trust_chain
in its payload and should not in its JWS header parameters.
¶
...
¶
Fixed #2110: Explanatory text when multiple
entity_type
parameters are provided in the Subordinate Listing endpoint.
¶
...
¶
Fixed #1659: Described use of the
trust_chain
header parameter in resolve responses.
¶
...
from the
federation_entity
Entity Type definition to the set of metadata parameters applicable to all Entity Types.
¶
...
Applications and protocols using Entity Statements MAY specify
        additional claims.
¶
Addressed #1655: The definitions of
aud
and
trust_anchor_id
are moved to the Explicit
...
Fixed #1947: Added
source_endpoint
as OPTIONAL in Entity Statement JWS.
¶
...
¶
Fixed #2061: Clarified that the
constraints
claim may only appear in statements issued by authorities.
¶
...
¶
Fixed #2064: Prohibited the use of
null
as a metadata value.
¶
Rewrote
...
-29
¶
Fixed #1921: brand new JWS Header parameter,
trust_chain
.
¶
...
¶
Listing endpoint - added the parameters
trust_marked
and
trust_mark_id
.
...
Fixed #1681:
RS256
is not mandatory anymore for federation operations signatures.
¶
...
¶
Fixed #1584: Stated that domain name constraints are as specified in Section 4.2.1.10 of
[
RFC5280
]
.
...
.
¶
Fixed #1512 - Registered the error codes
missing_trust_anchor
and
validation_failed
.
...
client_registration_types
(which was previously misregistered as
...
¶
Fixed #1519 - Corrected instances of
client_registration_type
to
client_registration_types_supported
.
...
Added
trust_marks
as a parameter in the Entity Statement.
¶
...
Added
RS256
as default signing algorithm for Entity Statements.
¶
Specified that the value of
aud
in the Entity Statement used in
            automatic client registration MUST be
            the AS's authorization endpoint URL.
            Also, the
sub
claim MUST NOT be present.
¶
...
.
¶
Every key in a JWK Set in an Entity Statement MUST have a
kid
.
¶
-12
...
URI:
https://www.linkedin.com/in/vladimirdzhuvinov/