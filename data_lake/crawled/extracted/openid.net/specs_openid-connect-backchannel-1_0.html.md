---
{
  "title": "Final: OpenID Connect\n    Back-Channel Logout 1.0 incorporating errata set 1",
  ...
  "date": "",
  "length": 35061,
  "crawled_at": "2026-04-23T20:49:36"
}
---
...
Back-Channel Logout
2.1.
Indicating OP Support for Back-Channel Logout
2.2.
Indicating RP Support for Back-Channel Logout
2.3.
Remembering Logged-In RPs
2.4.
Logout Token
2.5.
...
(
Jones, M. and J. Bradley, “OpenID Connect Back-Channel Logout 1.0 (final),” September 2022.
)
...
The
sid
(session ID) Claim used in ID Tokens and
...
formatted
	  query component, per Section 3.4 of
[RFC3986]
(
Berners-Lee, T., Fielding, R., and L. Masinter, “Uniform Resource Identifier (URI): Generic Syntax,” January 2005.
)
...
OPs send a JWT similar to an ID Token to RPs called a Logout Token
	  ...
	  ID Tokens are defined in Section 2 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
iss
REQUIRED.
	      Issuer Identifier, as specified in Section 2 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
sub
OPTIONAL.
	      Subject Identifier, as specified in Section 2 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
aud
REQUIRED.
	      Audience(s), as specified in Section 2 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
iat
REQUIRED.
	      Issued at time, as specified in Section 2 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
exp
REQUIRED.
	      Expiration time, as specified in Section 2 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
jti
REQUIRED.
	      Unique identifier for the token, as specified in Section 9 of
[OpenID.Core]
(
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, “OpenID Connect Core 1.0,” December 2023.
)
...
value need only be unique
	      ...
	      Its contents are opaque to the RP.
	      Its syntax is the same as an OAuth 2.0 Client Identifier.
A Logout Token MUST contain either a
sub
or a
sid
...
Claim is not present,
	  ...
	  for the End-User identified by the
iss
and
sub
...
(issuer) claim
	  ...
	  as specified in Section 5.3 of
[JWT]
(
Jones, M., Bradley, J., and N. Sakimura, “JSON Web Token (JWT),” May 2015.
)
...
for a discussion of the security and interoperability considerations
	  of using explicit typing.
NOTE: The Logout Token is compatible with
	  the Security Event Token (SET)
[RFC8417]
(
Hunt, P., Ed., Jones, M., Denniss, W., and M. Ansari, “Security Event Token (SET),” July 2018.
)
specification,
	  but uses a more specific
typ
(type) value.
...
(
Backman, A., Ed., Jones, M., Ed., Scurtescu, M., Ansari, M., and A. Nadalin, “Push-Based Security Event Token (SET) Delivery Using HTTP,” November 2020.
)
[RFC8935].)
TOC
2.6. 
...
Registration parameter
	      when they are used;
	      otherwise, the value SHOULD be the default of
RS256
.
	      Additionally, an
alg
with the value
none
MUST NOT be used for Logout Tokens.
Validate the
iss
,
aud
...
Refresh tokens issued without the
offline_access
property
	  to a session being logged out SHOULD be revoked.
	  Refresh tokens issued with the
offline_access
property
...
parameters
	  ...
	  These error response parameters are used as specified in Section 5.2 of
OAuth 2.0
(
Hardt, D., Ed., “The OAuth 2.0 Authorization Framework,” October 2012.
)
...
application/json
media type.
	  Also like in OAuth 2.0, the
error
parameter is REQUIRED when a response body is present
	  and the
error_description
...
MAY be used to indicate that there was a problem with the syntax of the logout request.
	  ...
	  it is not intended that implementations use different
error
values
	  to trigger different runtime behaviors.
The RP's response SHOULD include the
Cache-Control
HTTP response header field with a
no-store
value,
...
[RFC8725]
(
Sheffer, Y., Hardt, D., and M. Jones, “JSON Web Token Best Current Practices,” February 2020.
)
,
...
typ
(type) Header Parameter with a value of
logout+jwt
...
[RFC7591]
(
Richer, J., Ed., Jones, M., Bradley, J., Machulak, M., and P. Hunt, “OAuth 2.0 Dynamic Client Registration Protocol,” July 2015.
)
:
TOC
5.1.1. 
...
[RFC8414]
(
Jones, M., Sakimura, N., and J. Bradley, “OAuth 2.0 Authorization Server Metadata,” June 2018.
)
.
TOC
5.2.1. 
...
[RFC2046]
(
Freed, N. and N. Borenstein, “Multipurpose Internet Mail Extensions (MIME) Part Two: Media Types,” November 1996.
)
in the IANA "Media Types"
	    registry
[IANA.MediaTypes]
(
IANA, “Media Types,” .
...
[RFC6838]
(
Freed, N., Klensin, J., and T. Hansen, “Media Type Specifications and Registration Procedures,” January 2013.
)
...
,” BCP 13, RFC 6838, DOI 10.17487/RFC6838, January 2013.
[RFC7591]
Richer, J., Ed., Jones, M., Bradley, J., Machulak, M., and P. Hunt, “
OAuth 2.0 Dynamic Client Registration Protocol
,” RFC 7591, DOI 10.17487/RFC7591, July 2015.
[RFC8414]
Jones, M., Sakimura, N., and J. Bradley, “
OAuth 2.0 Authorization Server Metadata
,” RFC 8414, DOI 10.17487/RFC8414, June 2018.
[RFC8417]
Hunt, P., Ed., Jones, M., Denniss, W., and M. Ansari, “
Security Event Token (SET)
,” RFC 8417, DOI 10.17487/RFC8417, July 2018.
[RFC8725]
Sheffer, Y., Hardt, D., and M. Jones, “
JSON Web Token Best Current Practices
,” BCP 225, RFC 8725, DOI 10.17487/RFC8725, February 2020.
[RFC8935]
Backman, A., Ed., Jones, M., Ed., Scurtescu, M., Ansari, M., and A. Nadalin, “
Push-Based Security Event Token (SET) Delivery Using HTTP
,” RFC 8935, DOI 10.17487/RFC8935, November 2020.
TOC
Appendix A. 
Acknowledgements
...
Phil Hunt (phil.hunt@independentid.com), Independent Identity, Inc.
Michael B. Jones (michael_b_jones@hotmail.com), Self-Issued Consulting (was at Microsoft)
Todd Lainhart (lainhart@us.ibm.com), IBM
Torsten Lodderstedt (torsten@lodderstedt.net), independent (was at yes.com)
