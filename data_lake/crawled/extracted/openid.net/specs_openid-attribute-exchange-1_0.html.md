---
{
  "title": "Final: OpenID Attribute Exchange 1.0 - Final",
  "url": "https://openid.net/specs/openid-attribute-exchange-1_0.html",
  "domain": "openid.net",
  "depth": 1,
...
[OpenID.axschema]
(
Hardt, D., “Schema for OpenID Attribute Exchange,” May 2007.
)
.
This service extension defines two message types for
        transferring attributes: fetch (see
Section 5
(
Fetch Message
)
...
Discovery of the attribute exchange service extension is
        achieved via the mechanism described in
[OpenID.authentication‑2.0]
(
specs@openid.net, “OpenID Authentication 2.0 - Final,” August 2007.
)
...
A fetch response message may also be sent to the
          "update_url" specified in
Section 5.1
(
Fetch Request Format
)
in response to attribute value
...
Wahl, M.
, “
Language Tags for OpenID Values
,” April 2007.
[RFC2119]
Bradner, S.
, “
