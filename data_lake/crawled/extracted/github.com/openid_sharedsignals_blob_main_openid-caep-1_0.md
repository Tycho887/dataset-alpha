---
{
  "title": "sharedsignals/openid-caep-1_0.md at main · openid/sharedsignals · GitHub",
  "url": "https://github.com/openid/sharedsignals/blob/main/openid-caep-1_0.md",
  "domain": "github.com",
  "depth": 2,
  ...
  "date": "",
  "length": 30039,
  "crawled_at": "2026-04-23T20:52:30"
}
---
...
:
"
Landspeed-Richtlinienverstoß: C076E82F
"
,
"es-410"
:
"
Violación de la política de landspeed: C076E82F
"
}
}
...
:
"
Zugriffsversuch aus mehreren Regionen.
"
,
"es-410"
:
"
Intento de acceso desde varias regiones.
"
}
}
...
as
sub
claim (includes optional claims)"}
{
"iss"
:
"
...
:
"
This device is no longer compliant.
"
,
"it"
:
"
Questo dispositivo non è più conforme.
"
},
"event_timestamp"
:
...
:
"
https://idp.example.com/987654321/
"
,
"jti"
:
"
9afce1e4e642b165fcaacdd0e7aa4903
"
,
"iat"
:
...
:
"
f61t6e20zdo3px56gepu8rzlsp4c1dpc0fx7
"
},
"events"
: {
...
:
"
User left trusted network: CorpNet3
"
},
"reason_user"
: {
...
:
"
You're no longer connected to a trusted network.
"
,
"it"
:
"
Non sei più connesso a una rete attendibile.
"
},
"claims"
: {
...
:
"
dae94fed5f459881efa38b65c6772ddc
"
,
"iat"
:
...
:
"
accced6a-63f5-490a-9eea-e59bc1896cfc
"
,
"friendly_name"
:
"
Jane's USB authenticator
"
,
"initiating_entity"
:
...
ISO-IEC-29115
: The assurance level values are from the {{ISO-IEC-29115}}
specification
NIST-IAL
: The assurance level values are from the {{NIST-IDPROOF}}
specification
NIST-AAL
: The assurance level values are from the {{NIST-AUTH}}
specification
NIST-FAL
: The assurance level values are from the {{NIST-FED}}
specification
...
:
"
Location Policy Violation: C076E8A3
"
},
"reason_user"
: {
...
:
"
Device is no longer in a trusted location.
"
},
"event_timestamp"
:
...
:
"
abb0b6e7da81a42233f8f2b1a8ddb1b9a4c81611
"
,
"acr"
:
