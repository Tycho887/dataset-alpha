---
{
  "title": "sharedsignals/openid-sharedsignals-framework-1_0.md at main · openid/sharedsignals · GitHub",
  "url": "https://github.com/openid/sharedsignals/blob/main/openid-sharedsignals-framework-1_0.md",
  "domain": "github.com",
  "depth": 2,
  ...
  "date": "",
  "length": 86007,
  "crawled_at": "2026-04-23T20:52:23"
}
---
...
:
"
B70BA622-9515-4353-A866-823539EECBC8
"
}
...
: [
"
receiver.example.com/web
"
,
"
receiver.example.com/mobile
"
],
"iat"
:
...
:
"
72e6991badb44e08a69672960053b342
"
},
"events"
: {
...
:
"
VGhpcyBpcyBhbiBleGFtcGxlIHN0YXRlIHZhbHVlLgo=
"
}
  }
}
...
:
"
https://idp.example.com/3957ea72-1b66-44d6-a044-d805712b9288/
"
,
"sub"
:
...
:
"
Violación de velocidad en tierra.
"
},
"event_timestamp"
:
...
:
"
https://myservice.example3.com/
"
,
"jti"
:
"
756E69717565206964656E746966696534
"
,
"iat"
:
...
" to obtain its Transmitter Configuration Metadata, since
the Issuer contains no path component:
GET
/.well-known/ssf-configuration HTTP/1.1
Host:
tr.example.com
...
" to obtain its Transmitter
Configuration Metadata, since the Issuer contains a path component:
GET
/.well-known/ssf-configuration/issuer1 HTTP/1.1
Host:
tr.example.com
...
Metadata for the Transmitter "
https://risc-tr.example.com
" MAY be obtained by
making the following request:
GET
/.well-known/risc-configuration HTTP/1.1
Host:
risc-tr.example.com
...
/ssf/stream HTTP/1.1
Host:
transmitter.example.com
Authorization:
Bearer eyJ0b2tlbiI6ImV4YW1wbGUifQo=
{
"delivery"
: {
"method"
...
:
"
Stream for Receiver A using events type_2, type_3, type_4
"
}
...
configuration:
GET
/ssf/stream?stream_id=f67e39a0a4d34d56b3aa1bc4cff0069f HTTP/1.1
Host:
transmitter.example.com
Authorization:
Bearer eyJ0b2tlbiI6ImV4YW1wbGUifQo=
...
:
"
50b2d39934264897902c0581ba7c21a3
"
,
"iss"
:
...
:
"
Stream for Receiver B using events type_2, type_3, type_4
"
}
...
status:
GET
/ssf/status?stream_id=f67e39a0a4d34d56b3aa1bc4cff0069f HTTP/1.1
Host:
transmitter.example.com
Authorization:
Bearer eyJ0b2tlbiI6ImV4YW1wbGUifQo=
...
:
"
Disabled by administrator action.
"
}
...
and / or
events_delivered
fields in the Stream Configuration ({{stream-config}}).
...
if there is no Event Stream with the given "stream_id" for this Event Receiver
429
if the Event Receiver is sending too many requests in a given amount of time; see related "min_verification_interval" in {{stream-config}}
