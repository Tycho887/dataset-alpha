---
{
  ...
  "url": "https://www.ietf.org/archive/id/draft-jones-oauth-jwk-thumbprint-uri-00.html",
  "domain": "www.ietf.org",
  "depth": 2,
...
JWK Thumbprint URI
Abstract
This specification registers a family of URIs that represent
 JSON Web Key (JWK) Thumbprint values.
...
are a URL-safe representation of a hash value over a JSON Web Key (JWK).
 ...
 including in specific JSON Web Token (JWT)
[
RFC7519
]
claims.
...
Use cases for this specification were developed in the
 ...
 Specifically, its use is planned in future versions of the
[
SIOPv2
]
specification.
