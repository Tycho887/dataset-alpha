---
{
  "title": "RFC 3553:  An IETF URN Sub-namespace for Registered Protocol Parameters ",
  "url": "https://www.rfc-editor.org/rfc/rfc3553",
  ...
  "date": "",
  "length": 14695,
  "crawled_at": "2026-04-23T21:00:23"
}
---
...
Abstract
   ...
   defined in
RFC 2648
as a root for persistent URIs that refer to
...
From time to time IETF standards require the registration of various
   ...
   document creates a new sub-delegation below the "ietf" [
2
]URN
   namespace [
1
] called 'params' which acts as a standardized mechanism
   ...
   process and which include the template found in
Section 4
.
Mealling, et. al.        Best Current Practice                  [Page 1]
RFC 3553
IANA URN Namespace                  June 2003
2
.  Terminology
...
with the list of previously assigned names.  In the case of a
   ...
   Process of identifier assignment:
      ...
      for assignment is the "IETF Consensus" process documented in
RFC
2434
[
4
   ...
   Rules for Lexical Equivalence:
      ...
      the rules for URN syntax found in
RFC 2141
[
1
].  Specifically, due
...
None not already inherent to using URNs.  Security considerations for
   URNs in general can be found in
RFC 2141
[
1
].  Further security
...
, May 1997.
   ...
   [
2
]  Moats, R., "A URN Namespace for IETF Documents",
RFC 2648
,
        August 1999.
...
, May 2002.
   ...
   [
7
]  Hoffman, P. and M. Blanchet, "Preparation of Internationalized
        Strings ("stringprep")",
RFC 3454
, December 2002.
