...
RFC 6838
Media Type Registration            January 2013
Table of Contents
1
.  Introduction . . . . . . . . . . . . . . . . . . . . . . . . .
3
...
24
6.2
.  Structured Syntax Suffix Registration Template . . . . . .
24
7
...
The media type registration process was initially defined for
   ...
   initially done in [
RFC2048
], but the procedure defined there was
...
It may be desirable to restrict the use of media types to specific
   ...
   registrations in a systematic way.  See
Section 4.9
for additional
   discussion.
1.2
...
RFC2119
   ...
   [
RFC5234
] notation, including the core rules defined in
Appendix B
of
   that document.
2
...
In order to increase the efficiency and flexibility of the
   ...
   not conform to the naming conventions described below.  See
Appendix
A
...
1.  in the case of registrations associated with IETF specifications,
   ...
   2.  registered by a recognized standards-related organization using
       the "Specification Required" IANA registration policy [
RFC5226
]
...
Appendix A
) and/or otherwise incomplete registration is in the
...
RFC5226
] prior to approval.  In this case, the
...
While public exposure and review of media types to be registered in
   ...
   mailing list (see
Section 5.1
) for review is encouraged, to improve
...
Subtype names with "x." as the first facet may be used for types
   ...
   considered to be members of this tree (see [
RFC6648
]).  Also note
...
RFC2045
], base64 cannot be registered as a
   media type.
...
The "text" top-level type is intended for sending material that is
   ...
   which is a generic subtype for plain text defined in [
RFC2046
],
...
RFC2978
   ...
   As specified in [
RFC6657
], a "charset" parameter SHOULD NOT be
...
RFC6657
   ...
   US-ASCII default defined in
Section 4.1.2 of [RFC2046]
is no longer
...
A top-level type of "video" indicates that the content specifies a
   ...
   in a single body is discouraged [
RFC2046
...
Multipart and message are composite types; that is, they provide a
   ...
   rules and other requirements specified in [
RFC2046
] and amended by
...
[
RFC5378
] on the use of patented technology
...
type in [
RFC2046
] for an example of such directives and how they
...
Media type registrations can specify how applications should
   interpret fragment identifiers (specified in
Section 3.5 of
   [RFC3986]
...
Various sorts of optional information SHOULD be included in the
   ...
   o  Mac OS File Type code(s) (4 octets) used to label files containing
      ...
      and their purpose can be found in [
MacOSFileTypes
].
...
With the exception of provisional standards-tree registrations,
   ...
   IESG using the procedure specified in
Section 6.5.4 of [RFC2026]
.
...
+suffix
   ...
   Encoding considerations
      ...
      for media type encoding considerations given in
Section 4.8
apply
      here.
   ...
   Security considerations
      ...
      for media type security considerations given in
Section 4.6
apply
...
Security requirements for both media type and media type suffix
   registrations are discussed in
Section 4.6
.
...
for additional information on
   ...
   o  The registration process is specified in
Section 6
.
...
RFC4288
].  We hope that the current version is one with
...
, October 2000.
   ...
   [
RFC3023
]         Murata, M., St. Laurent, S., and D. Kohn, "XML
                     Media Types",
RFC 3023
, January 2001.
...
,
   ...
   [
RFC5378
]         Bradner, S. and J. Contreras, "Rights Contributors
                     Provide to the IETF Trust",
BCP 78
,
RFC 5378
,
...
,
   ...
   [
RFC6657
]         Melnikov, A. and J. Reschke, "Update to MIME
...
[
MacOSFileTypes
]  Apple Computer, Inc., "Mac OS: File Type and
...
A number of media types with unfaceted subtype names, registered
   ...
   deprecated alias to identify the original name (see
Section 4.2.9
).
